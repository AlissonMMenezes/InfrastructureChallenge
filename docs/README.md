...
| [terraform.md](terraform.md) | Hetzner provisioning |
| [ansible.md](ansible.md) | Cluster bootstrap (see also `ansible/README.md`) |
| [gitops.md](gitops.md) | Flux layout, TLS, OpenBao bootstrap summary |
